...
if (fs.existsSync(journalPath)) {
  ...
  const dayBlocks = journalContent
    .split(/^## /m)
...
console.log(
  `Generated ${outputFile} with ${Object.values(solutions).flat().length} solutions and ${journalData.length} journal entries embedded.`,
);
